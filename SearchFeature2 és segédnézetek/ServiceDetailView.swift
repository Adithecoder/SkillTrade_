...
//
//
//                        Text("A munkavégzés során minden szükséges eszközt és anyago//t       a munkaadó biztosít, kivéve ha másképp állapodtok me//g.      Ezeket az eszközöket és anyagokat a munkavégzés előtt át//        kell adnia számodra, de az átvételtől kezdve te vagy//        felelős értük. A munkavégzés során keletkezett károkért //        is te vagy felelős, kivéve ha bizonyítani tudod, hogy a //        károkozás nem a te hibádból ered.")
//                            .padding(10)
//                            .font(.custom("OrelegaOne-Regular", size: 16))
//                            .foregroundColor(.black)
//                            .background(
...
//
//
//                        Text("A munkádért járó kifizetésedet a SkillTrad//e       alkalmazásban fogod megkapni, a munkavégzés befejezé//se      után. A kifizetés általában 24 órán belül megtörténik, d//e       előfordulhat, hogy ennél hosszabb időt is igénybe vehet.//        Amennyiben a munkaadó készpénzzel fizet,a sikeres fizeté//s       után az alkalmazásban tudod megerősíteni a fizetést.//        Fontos, hogy a munkavégzés során mindig tartsd be a //        munkaadóval kötött megállapodást és a SkillTrade//        szabályait.")
//                            .padding(10)
//                            .font(.custom("OrelegaOne-Regular", size: 16))
//                            .foregroundColor(.black)
//                            .background(
