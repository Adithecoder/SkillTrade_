//
//  UserProfileSetupViewModel 3.swift
//  SkillTrade
//
...
class UserProfileSetupViewModel3: ObservableObject {
    @Published var jobTitle = ""
    @Published var jobDescription = ""
    @Published var selectedJobTypes: Set<JobType3> = []
    ...
    func toggleJobType(_ jobType: JobType3) {
...
// MARK: - Job Type Model
public enum JobType3: String, CaseIterable {
...
struct RiverFlowMeshGradient3: View {
        ...
        ZStack {
            ...
            LinearGradient(
                gradient: Gradient(colors: [
                    Color( #colorLiteral(red: 0.2632160187, green: 0.4376042783, blue: 0.296723485, alpha: 1)),   // Deep blue
                    Color(#colorLiteral(red: 0.2632160187, green: 0.4376042783, blue: 0.296723485, alpha: 1)),    // River blue
                    Color(#colorLiteral(red: 0.6489544511, green: 0.9740120769, blue: 0.6600705981, alpha: 1)),     // Light blue
                    Color(#colorLiteral(red: 0.6489544511, green: 0.9740120769, blue: 0.6600705981, alpha: 1))      // Medium blue
                ]),
...
struct UserProfileSetupView3: View {
    @StateObject private var viewModel = UserProfileSetupViewModel3()
            ...
            .toolbar {
                ToolbarItem(placement: .navigationBarLeading) {
                    ...
                    .foregroundStyle(LinearGradient(
                        gradient: Gradient(colors: [Color.mint, Color.DesignSystem.oliva]),
                        startPoint: .leading,
                        endPoint: .trailing
                    ))
                }
    ...
    private var headerSection: some View {
        VStack(spacing: 15) {
            ...
            Text("Milyen munkákat fogsz elvállalni? Ezekre jelentkezhetsz a jövőben.")
    ...
    private var jobTypesSection: some View {
        VStack(alignment: .leading, spacing: 15) {
            ...
            LazyVGrid(columns: [
                ...
                ForEach(JobType3.allCases, id: \.self) { jobType in
                    JobTypeBubble3(
                        jobType: jobType,
                    ...
                    .animation(SwiftUI.Animation.easeOut.delay(0.6 + Double(JobType3.allCases.firstIndex(of: jobType) ?? 0) * 0.05), value: appear)
                }
            }
        }
    }
...
struct JobTypeBubble3: View {
    let jobType: JobType3
    let isSelected: Bool
    let action: () -> Void
    ...
    var body: some View {
        ...
        .buttonStyle(ScaleButtonStyle4())
    }
}

// MARK: - Scale Button Style
struct ScaleButtonStyle4: ButtonStyle {
...
struct UserProfileSetupView3_Previews: PreviewProvider {
    static var previews: some View {
        UserProfileSetupView3()
    }
}
